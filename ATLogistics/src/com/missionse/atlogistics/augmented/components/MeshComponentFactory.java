package com.missionse.atlogistics.augmented.components;
...
public class MeshComponentFactory {
	...
	public static Headline createHeadlineInfo(String msg){
		return new Headline(R.drawable.infoboxblue,msg);
	}
	public static Headline createHeadlineWarning(String msg){
		return new Headline(R.drawable.warningcirclered,msg);
	}
